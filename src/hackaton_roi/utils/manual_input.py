...
def collect_manual_input() -> dict:
    ...
    # Question 1
    business_type = st.text_input("What is your type of business? (Example: Restaurant, Online Store, Industry, SaaS)")
    ...
    # Question 3
    store_type = st.selectbox("Will your company be physical, online, or hybrid?", 
                             ["", "Physical", "Online", "Hybrid"])
    
    # Question 4
    rental_status = st.selectbox("Do you already have a location or will you need to rent/buy a space?",
    ...
    # Question 6
    sales_channel = st.multiselect("How do you plan to sell?", 
    ...
    # Question 10
    work_structure = st.radio("Will you work alone or hire employees?", 
                             ["Alone", "With employees", "Haven't decided yet"])
    
    # Question 11
    has_emergency_fund = st.radio("Do you have any money set aside for emergencies in case the business takes time to profit?", 
                                 ["Yes", "No"])
    
    # Question 12
    knows_breakeven = st.radio("Do you know how to calculate how much you need to sell to cover your costs?", 
                              ["Yes", "No"])
    
    # Question 13
    has_defined_price = st.radio("Have you already defined a price for your product/service?", 
                               ["Yes", "No"])
